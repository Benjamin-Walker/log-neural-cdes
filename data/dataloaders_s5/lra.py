...
from .base import default_data_path, ImageResolutionSequenceDataset, SequenceDataset
...
class IMDB(SequenceDataset):
    ...
    def _cache_dir_name(self):
        return (
            f"l_max-{self.l_max}-level-{self.level}-min_freq-{self.min_freq}"
            f"-append_bos-{self.append_bos}-append_eos-{self.append_eos}"
        )
