...
ORIGINAL_DATA_DIR_32 = ""
ORIGINAL_DATA_DIR_64 = ""
ORIGINAL_DATA_DIR_128 = ""
ORIGINAL_DATA_DIR_256 = ""
        ...
        def _generate_examples(file_path):
            ...
            for m_example in meta_examples:
                ...
                image_path = os.path.join(
                    ORIGINAL_DATA_DIR_32, file_pattern, m_example[0], m_example[1]
                )
                example_id += 1
    ...
    def _build_pcollection(self, pipeline, file_pattern):
        ...
        def _generate_examples(file_path):
            ...
            for m_example in meta_examples:
                m_example = m_example.split(" ")
                image_path = os.path.join(
                    ORIGINAL_DATA_DIR_64, file_pattern, m_example[0], m_example[1]
                )
                example_id += 1
                yield "_".join([m_example[0], m_example[1], str(example_id)]), {
                    "image": image_path,
    ...
    def _build_pcollection(self, pipeline, file_pattern):
        ...
        def _generate_examples(file_path):
            ...
            for m_example in meta_examples:
                m_example = m_example.split(" ")
                image_path = os.path.join(
                    ORIGINAL_DATA_DIR_128, file_pattern, m_example[0], m_example[1]
                )
                example_id += 1
                yield "_".join([m_example[0], m_example[1], str(example_id)]), {
                    "image": image_path,
    ...
    def _build_pcollection(self, pipeline, file_pattern):
        ...
        def _generate_examples(file_path):
            ...
            for m_example in meta_examples:
                m_example = m_example.split(" ")
                image_path = os.path.join(
                    ORIGINAL_DATA_DIR_256, file_pattern, m_example[0], m_example[1]
                )
                example_id += 1
                yield "_".join([m_example[0], m_example[1], str(example_id)]), {
                    "image": image_path,
