...
def convert_tc_datasets(n_devices, task_name, data_dir=None, batch_size=256, fixed_vocab=None, max_length=512, tokenizer='char'):
    ...
    return train_data_list, val_data_list, test_data_list, train_targets_list, val_targets_list, test_targets_list
...
if __name__ == '__main__':
    ...
    train_data, val_data, test_data, train_labels, val_labels, test_labels = convert_tc_datasets(n_devices=jax.local_device_count(),
        task_name=task_name,
        data_dir=data_dir,
